    ...
    handleChange(e) {
        ...
        this.setState((prevState) => {
            if(name==="instock"){
                ...
                prevState.product[name] = target.checked?true:false;
            }
            else{
    ...
    render () {
        return (
            <form>
                ...
                <p>
                    <label>Product Id <br /> 
                    <input type="number" className="form-control" name="productid" onChange={this.handleChange} value={this.state.product.productid} /></label>
                </p>
                <p>
                    <label>Name <br /> 
                ...
                <p>
                    <label>Price <br /> 
                    <input type="number" className="form-control" name="price" onChange={this.handleChange} value={this.state.product.price} /></label>
                </p>
                <p>
                    <label>In stock<br /> <br /> 
                ...
                <input type="submit" className="btn btn-info h-25" value="Save" onClick={this.handleSave}></input>
            </form>
        )
    }
}
